...
while (~isInit)
    ...
    for i=1:nPop
        ...
        position_old1 = repair_x(position_old,model);
        position_old2 = repair_y(position_old1,model);
        position_new = repair_z(position_old2,model);
...
TotalTimeUsed = toc(TimeStartOverall);  
disp(['Total running time for 30 runs: ' num2str(TotalTimeUsed) ' seconds']);
